        ...
        <main className="max-w-[720px] mx-auto">
            ...
            <form className="mt-12 space-y6 grid grid-cols-2 gap-6">
                <div className="col-span-full md:col-span-1">
                    ...
                    <input type="text" id="first_name" required {...register("first_name")} placeholder="Enter your first name" className="form__field"/>
                    {first_name?.message ?
                ...
                <div className="col-span-full md:col-span-1">
                    ...
                    <input type="text" id="last_name" required {...register("last_name")} placeholder="Enter your last name" className="form__field"/>
                    {last_name?.message ?
                ...
                <div className="col-span-full">
                    ...
                    <input type="text" required id="email" {...register("email")} placeholder="yourname@email.com" className="form__field"/>
                    {email?.message ?
                ...
                <div className="col-span-full">
                    ...
                    <textarea rows={5} id="message" {...register("message")} required placeholder="Send me a message and I'll reply you as soon as possible..." className="form__field message__field"/>
                    {message?.message ?
